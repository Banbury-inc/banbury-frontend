...
import * as notificationsApi from '../../../../neuranet/notifications';
...
describe('NotificationsButton', () => {
    ...
    it('marks notification as read when clicking mark as read button', async () => {
        (notificationsApi.markNotificationAsRead as jest.Mock).mockResolvedValueOnce({});
    ...
    it('deletes notification when clicking delete button', async () => {
        (notificationsApi.deleteNotification as jest.Mock).mockResolvedValueOnce({});
        ...
        await waitFor(() => {
            expect(notificationsApi.deleteNotification).toHaveBeenCalledWith('1', 'testuser');
        }, { timeout: 1000 });
    });
    ...
    it('removes all notifications when clicking "Remove all"', async () => {
        ...
        await waitFor(() => {
            expect(notificationsApi.deleteNotification).toHaveBeenCalledWith('1', 'testuser');
            expect(notificationsApi.deleteNotification).toHaveBeenCalledWith('2', 'testuser');
        }, { timeout: 1000 });
    });
