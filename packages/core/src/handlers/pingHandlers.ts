...
import { DeviceInfo as DeviceInfoType } from '../types/Types'; // Assuming DeviceInfoType is defined in a types file
import { SmallDeviceInfo as SmallDeviceInfoType } from '../types/Types'; // Assuming DeviceInfoType is defined in a types file
